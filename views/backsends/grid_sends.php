...
$this->title = 'Back Sends';

echo SwiperSlider::widget([
    'slides' => [
        'one', //Просто текст
        '<img src="https://swiperjs.com/demos/images/nature-1.jpg">', //Просто картинка
        [
            'value' => 'Картинка с текстом',
            'options' => [
    ...
    'options' => [
        'styles' => [
            SwiperSlider::CONTAINER => ["width" => "100px"],
            SwiperSlider::CONTAINER => ["height" => "245px"], //Высота со слайдами
            SwiperSlider::SLIDE => ["text-align" => "center"], //Расположение текста (slides->value->"")
        ],
    ],
]);
...
echo Html::a("Отправить запрос", ["add"], ['class'=> 'btn btn-success']);
...
echo GridView::widget([
    ...
    'columns' => [
        ...
        'subject',
        'message',
        ['attribute' => 'date_create', 'format' => ['date', 'php:Y-m-d H:i:s']],//'Date_Create',
